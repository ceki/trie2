...
public class TriePerf {
    ...
    void buildRuleStore(RuleStore rs) {
        ...
        rs.addRule(new ElementSelector("configuration/contextName"), new NOPAction());
        rs.addRule(new ElementSelector("configuration/contextListener"), new NOPAction());
        rs.addRule(new ElementSelector("configuration/insertFromJNDI"), new NOPAction());
        ...
        rs.addRule(new ElementSelector("configuration/logger/appender-ref"), new NOPAction());
        rs.addRule(new ElementSelector("configuration/root/appender-ref"), new NOPAction());
        rs.addRule(new ElementSelector("configuration/jmxConfigurator"), new NOPAction());
        rs.addRule(new ElementSelector("configuration/include"), new NOPAction());
        rs.addRule(new ElementSelector("configuration/consolePlugin"), new NOPAction());
        rs.addRule(new ElementSelector("configuration/receiver"), new NOPAction());
        ...
        rs.addRule(new ElementSelector("configuration/substitutionProperty"), new NOPAction());
        ...
        rs.addRule(new ElementSelector("configuration/contextProperty"), new NOPAction());
        rs.addRule(new ElementSelector("configuration/conversionRule"), new NOPAction());
        rs.addRule(new ElementSelector("configuration/statusListener"), new NOPAction());
        rs.addRule(new ElementSelector("configuration/appender"), new NOPAction());
        rs.addRule(new ElementSelector("configuration/appender/appender-ref"), new NOPAction());
